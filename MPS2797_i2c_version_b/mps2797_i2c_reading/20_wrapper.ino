...
// -- PWR_STATUS (0x01) --
/**
 * @brief (Helper) Reads the raw PWR_STATUS register from the I2C bus.
...
// -- STB_STATUS (0x02) --
/**
 * @brief (Helper) Reads the raw STB_STATUS register from the I2C bus.
 */
...
/**
 * @brief (Helper) Reads the raw LOAD_CHARGER_STATUS register from the I2C bus.
 */
